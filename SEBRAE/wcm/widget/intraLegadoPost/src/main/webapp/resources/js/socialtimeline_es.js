	...
	.extend({
		...
		i18n: {
			...
			'labels': {
				...
				'revision': 'Revisión',
				'details': 'Ver más',
				'sharedsocial': 'fue compartido',
				'documentremoved': 'Contenido eliminado',
				'unreachableContent': 'Contenido inaccesible',
				'lastpublications': 'Últimas publicaciones',
				'this.publication': 'una publicación',
				'this.content': 'un contenido',
				'this.article': 'un artículo',
				'this.form': 'Un formulario',
				'this.image': 'esta imagen',
				'this.video': 'este video',
				'this.gallery': 'esta galería',
				'this.connection': 'una conexión',
				'this.document': 'un documento',
				'recommended': 'compartió',
				'on': 'en',
				'via': 'via',
				'LAST_UPDATE': 'Comentarios recientes',
				'MORE_LIKE': 'Cantidad de apoyos',
				'MY_PUBLICATIONS': 'Mis publicaciones',
				'CREATION_DATE': 'Últimas publicaciones',
				'timelinewithoutcontent': 'Timeline sin contenido',
				'notcontent': 'No existe contenido publicado',
				'incommunity': 'en la comunidad',
				'errorvideo': 'Para visualizar el video, por favor habilite JavaScript, y considere la actualización hacia un navegador que cuente con soporte para video HTML5.',
				'like': 'Apoyar',
				'dislike': 'Cancelar apoyo',
				'manylike': 'apoya(n)',
				'comment': 'Comentar',
				'leaveyourcomment': 'Deje su comentario',
				'startwatching': 'Notificar',
				'stopwatching': 'Parar de notificar',
				'manywatch': 'acompaña(n)',
				'recommend': 'Compartir',
				'denounce': 'Denunciar',
				'remove': 'Eliminar',
				'manycomment': 'comentaron',
				'postnotfound': 'Publicación no encontrada',
				'postnotfoundmessage': 'Esta publicación puede haber sido removida o usted no posee permiso suficiente para visualizarla.',
				'unavailabletimeline': '¡Timeline inaccesible!',
				'contactadministrator': 'Póngase en contacto con el administrador para obtener más información sobre las restricciones de acceso.',
				'commentsending': 'Enviando...',
				'documentView': 'Visualización de documento',
				'anwser': 'responder',
				'errorLoadingArticle': 'Error al cargar artículo.',
				'edit' :'Editar',
				'edited' :'Editado',
				'in' :'en',
				'cancel' :'Cancelar',
			...
			'messages': {
				'genericerror': 'Se ha producido una falla en la comunicación. Actualice la página y vuelva a intentarlo.',
				'confirm.post.exclusion': '¿Confirma la exclusión del post?',
				'confirm.comment.exclusion': '¿Confirma la exclusión del comentario?',
				'comment.empty': 'Complete el comentario',
				'comment.max': 'El comentario debe tener hasta 600 caracteres',
				'comment.max.denounce': 'El comentario debe tener hasta 255 caracteres',
				'remove.post': 'Eliminar publicación',
				'remove.comment': 'Eliminar comentario',
				'video.not.supported': 'Lo siento, este video no es compatible con su navegador. Descargue el video o utilice otro navegador.',
				'post.denounced': 'El contenido fue denunciado por contener palabras restringidas y ya no está disponible',
				'comment.denounced': 'Debido a la sospecha de contenido ofensivo, su comentario se eliminará de manera temporal.',
				'denounce.reason.empty': 'Debe completarse el motivo de la denuncia.',
				'denounce.content.invalid': 'Contenido de la descripción de la denuncia inválida',
				'videoNotSupported': 'Este video no es compatible con su navegador.',
				'videoNotSupportedDownload': 'Descargue el video.',
				'videoNotSupportedSulfix': 'o utilice otro navegador.',
				'post.success.edited': 'Post editado',
				'comment.success.edited': 'Comentario editado'
			}
		},
