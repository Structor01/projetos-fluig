	...
	.extend({
		...
		i18n: {
			...
			'labels': {
				...
				'details': '${i18n.getTranslation("details")}',
				'sharedsocial': '${i18n.getTranslation("shared.social")}',
				'documentremoved': '${i18n.getTranslation("documentRemoved")}',
				'unreachableContent': '${i18n.getTranslation("unreachableContent")}',
				'lastpublications': '${i18n.getTranslation("last.publications")}',
				'this.publication': '${i18n.getTranslation("this.publication")}',
				'this.content': '${i18n.getTranslation("this.content")}',
				'this.article': '${i18n.getTranslation("this.article")}',
				'this.form': '${i18n.getTranslation("this.form")}',
				'this.image': '${i18n.getTranslation("this.image")}',
				'this.video': '${i18n.getTranslation("this.video")}',
				'this.gallery': '${i18n.getTranslation("this.gallery")}',
				'this.connection': '${i18n.getTranslation("this.connection")}',
				'this.document': '${i18n.getTranslation("this.document")}',
				'recommended': '${i18n.getTranslation("recommended")}',
				'on': '${i18n.getTranslation("on")}',
				'via': '${i18n.getTranslation("via")}',
				'LAST_UPDATE': '${i18n.getTranslation("recently.publication")}',
				'MORE_LIKE': '${i18n.getTranslation("more.like")}',
				'MY_PUBLICATIONS': '${i18n.getTranslation("my.publications")}',
				'CREATION_DATE': '${i18n.getTranslation("last.publications")}',
				'timelinewithoutcontent': '${i18n.getTranslation("timeline.without.content")}',
				'notcontent': '${i18n.getTranslation("not.content")}',
				'incommunity': '${i18n.getTranslation("in.community")}',
				'errorvideo': '${i18n.getTranslation("message.error.video")}',
				'like': '${i18n.getTranslation("like")}',
				'dislike': '${i18n.getTranslation("dislike")}',
				'manylike': '${i18n.getTranslation("many.like")}',
				'comment': '${i18n.getTranslation("comment")}',
				'leaveyourcomment': '${i18n.getTranslation("leave.your.comment")}',
				'startwatching': '${i18n.getTranslation("start.watching")}',
				'stopwatching': '${i18n.getTranslation("stop.watching")}',
				'manywatch': '${i18n.getTranslation("many.watch")}',
				'recommend': '${i18n.getTranslation("recommend")}',
				'denounce': '${i18n.getTranslation("denounce")}',
				'remove': '${i18n.getTranslation("remove")}',
				'manycomment': '${i18n.getTranslation("many.comment")}',
				'postnotfound': '${i18n.getTranslation("post.not.found")}',
				'postnotfoundmessage': '${i18n.getTranslation("post.not.found.message")}',
				'unavailabletimeline': '${i18n.getTranslation("unavailable.timeline")}',
				'contactadministrator': '${i18n.getTranslation("contact.administrator")}',
				'commentsending': '${i18n.getTranslation("label.comment.sending")}',
				'documentView': '${i18n.getTranslation("label.document.view")}',
				...
				'cancel' :'${i18n.getTranslation("label.cancel")}',
				'publish' :'${i18n.getTranslation("label.publish")}',
			},
			'messages': {
				'genericerror': '${i18n.getTranslation("message.generic.error")}',
				'confirm.post.exclusion': '${i18n.getTranslation("confirm.post.exclusion")}',
				'confirm.comment.exclusion': '${i18n.getTranslation("confirm.comment.exclusion")}',
				'comment.empty': '${i18n.getTranslation("comment.empty")}',
				'comment.max': '${i18n.getTranslation("comment.max")}',
				'comment.max.denounce': '${i18n.getTranslation("comment.max.denounce")}',
				'remove.post': '${i18n.getTranslation("title.modal.remove.post")}',
				'remove.comment': '${i18n.getTranslation("title.modal.remove.comment")}',
				...
				'comment.denounced': '${i18n.getTranslation("comment.denounced")}',
