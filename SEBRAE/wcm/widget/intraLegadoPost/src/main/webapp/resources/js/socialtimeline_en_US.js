	...
	.extend({
		...
		i18n: {
			...
			'labels': {
				...
				'revision': 'Review',
				'details': 'See more',
				'sharedsocial': 'was shared',
				'documentremoved': 'Content removed',
				'unreachableContent': 'Inaccessible content',
				'lastpublications': 'Last publications',
				'this.publication': 'a publication',
				'this.content': 'a content',
				'this.article': 'an article',
				'this.form': 'a form',
				...
				'on': 'at',
				'via': 'via',
				'LAST_UPDATE': 'Recent comments',
				'MORE_LIKE': 'Number of supports.',
				'MY_PUBLICATIONS': 'My posts',
				'CREATION_DATE': 'Last publications',
				'timelinewithoutcontent': 'Timeline without content',
				'notcontent': 'There is no published content',
				'incommunity': 'in the community',
				'errorvideo': 'To view the video, please enable JavaScript, and consider upgrading to a browser that supports HTML5 video.',
				'like': 'Support',
				'dislike': 'Cancel support',
				'manylike': 'support(s)',
				'comment': 'Comment',
				'leaveyourcomment': 'Leave your comment',
				'startwatching': 'Notify',
				'stopwatching': 'Stop notifying',
				'manywatch': 'follow(s)-up',
				'recommend': 'Share',
				'denounce': 'Report',
				'remove': 'Remove',
				'manycomment': 'commented',
				'postnotfound': 'Post not found',
				'postnotfoundmessage': 'This post may have been removed or you do not have sufficient permission to view it.',
				'unavailabletimeline': 'Timeline inaccessible!',
				'contactadministrator': 'Contact your administrator for further information about access restrictions.',
				'commentsending': 'Sending...',
				'documentView': 'Document view',
				'anwser': 'reply',
				'errorLoadingArticle': 'Error loading the article',
				'edit' :'Edit',
				'edited' :'Edited',
				'in' :'at',
				'cancel' :'Cancel',
			...
			'messages': {
				'genericerror': 'Failure in communication. Please refresh the page and try again.',
				'confirm.post.exclusion': 'Confirm post deletion?',
				'confirm.comment.exclusion': 'Confirm comment deletion?',
				'comment.empty': 'Fill out the comment',
				'comment.max': 'Comment must have up to 600 characters',
				'comment.max.denounce': 'Comment must have up to 255 characters',
				'remove.post': 'Delete post',
				'remove.comment': 'Delete comment',
				'video.not.supported': 'Oops. This video is not supported by your browser. Please download the video or use another browser.',
				'post.denounced': 'The content was reported for containing blacklisted words and is no longer available',
				'comment.denounced': 'Due to suspicion of offensive content, your comment will be temporarily removed.',
				'denounce.reason.empty': 'The reason for the report must be filled out.',
				'denounce.content.invalid': 'Report description content invalid',
				'videoNotSupported': 'This video is not supported by your browser.',
				'videoNotSupportedDownload': 'Download the video',
				'videoNotSupportedSulfix': 'or use another browser.',
				'post.success.edited': 'Post edited',
				'comment.success.edited': 'Comment edited'
			}
		},
