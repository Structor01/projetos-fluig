...
//	companyId  		= new java.lang.Integer(getValue("WKCompany"));
	...
	if(thisActivity == 81 && sequenceId == 90){
...
//			var userName = getParametrosGerais("WS_USERNAME");
			...
			if(eMailOK && parseInt(pdfCreated) > 0){
				...
				historicoProcesso 	= historicoProcesso + "<pre><b>DADOS DE MOVIMENTAÇÃO AUTOMÁTICA DURANTE GERAÇÃO PDF e ENVIO DE eMails</b>" + "<br><br>";
